const addBrandForm = (edit) => {
    ...
    if (edit) {
        confHeadDiv.innerHTML = `
            ...
            <svg xmlns="http://www.w3.org/2000/svg" onclick="document.getElementById('content').click()" viewBox="0 0 16 16">
    ...
    if (edit) {
        ...
        <form action="/brands" method="POST" enctype="multipart/form-data">
            ...
            <div class="brand-submit">
                <button type="submit" class="brand-submit-btn" onclick="return window.confirm('Do you want to submit the form?')">Add Brand</button>
            </div>
        </form>`;
